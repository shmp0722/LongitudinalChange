function Long_AFQ_PlotPatientIndividual_LHON6
...
% load '/sni-storage/wandell/biac2/wandell/data/Longitudinal_LHON/results_3192015/afq_Whole_PrePost_sameOTOR3192015.mat';
load '/sni-storage/wandell/biac2/wandell/data/Longitudinal_LHON/results_4042015/afq_Whole_PrePost_sameOTOR4042015.mat';
afqP = afq;

% select only LHON6
afqP = AFQ_set(afqP,'sub_group',[1 1 0 0 ]);
...
outdir = '/sni-storage/wandell/biac2/wandell/data/Longitudinal_LHON/result';
...
%     end
    ...
    cVals = AFQ_get(afqN,'control data');
...
SO_AFQ_MakeFiberGroupMontage(afqP, fgNames, tube , fgColors, subNums, plotDims, numfibers);
