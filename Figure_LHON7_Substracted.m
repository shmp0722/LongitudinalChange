function Figure_LHON7_Substracted
...
SubDir=fullfile(homeDir,'LHON7-TT-dMRI-Anatomy');

% dt6 files
Pre_dt6 =fullfile(SubDir,'/dwi_2nd/dt6.mat');
Post_dt6 =fullfile(homeDir,'LHON7-TT-2nd-20150222/dwi_2nd/dt6.mat');
...
Fg = {'LOTD4L4.pdb','ROTD4L4.pdb','LOR1206_D4L4.pdb','ROR1206_D4L4.pdb'};
